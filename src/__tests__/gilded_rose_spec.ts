...
describe("Gilded Rose", () => {
    ...
    describe('Regular item', () => {
        it("decreases sellin by 1 of regular item if quality>0", () => {
        ...
        it("doesnt increase quality of regular item if it's already 50", () => {
        ...
        it("doesnt decrease the quality if it's already 0", () => {
    ...
    describe('Aged Brie', () => {
        it("decreases sellin by 1 of Aged Brie and increase quality by 1 if <50", () => {
        ...
        it("increases quality of Aged Brie by 2 if expired", () => {
        ...
        it("doesnt increase quality of Aged Brie if it's already 50", () => {
